...
class TestUtilities(TestConfig):
    ...
    def login(self, driver=None, username=None, password=None):
        """
    ...
    def get_resource(self, resource_name, path,
        ...
        if not driver:
            driver = self.base_driver
        driver.get(self.config['app_url'] + path)
    ...
    def create_mobile_location(self, location_name, driver=None):
        ...
        if not driver:
            driver = self.base_driver
        driver.get(self.config['app_url'] + '/admin/geo/location/add/')
        ...
        self.objects_to_delete.append(driver.current_url)
        driver.get(self.config['app_url'] + '/admin/geo/location/')
